    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (manualInput) {
            manualInput.addEventListener('change', async function(e) {
                ...
                if (files.length > 3) {
                    alert("Maksimal 3 foto. 3 foto pertama yang akan diproses.");
                }
        ...
        if (startBtn) {
            startBtn.onclick = async function() {
                try {
                    ...
                    alert('Tidak dapat mengaktifkan kamera (' + err.name + '). Pastikan izin kamera telah diberikan di browser atau gunakan tombol unggah foto.');
                }
            };
        }
